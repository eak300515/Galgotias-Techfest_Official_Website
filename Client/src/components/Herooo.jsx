...
const Herooo = () => {
  ...
  Step into the world of tomorrow with Galgotias Techfest 2025 – a journey through groundbreaking innovations, interactive experiences, and future-ready tech.
</p>
...
<div className="flex flex-wrap justify-center gap-4 mb-8">
  ...
  <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs w-full sm:w-auto text-center">
    ...
    <p className="text-gray-500 text-sm">January 2025</p>
          ...
          <Button 
    as="a"
    href="/Galgotias_Techfest_2025_Brochure.pdf"
    download="Galgotias_Techfest_2025_Brochure.pdf"
    target="_blank"
  ...
  <Button onClick={handleScrollToForm} white>
      Register Now!
    </Button> 
</div>
